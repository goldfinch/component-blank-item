...
namespace Goldfinch\Component\BlankItem\Blocks;
...
class BlanksBlock extends BaseElement
{
    private static $table_name = 'BlanksBlock';
    private static $singular_name = 'Blanks';
    ...
    {
        return BlankItem::get();
    }

    public function Categories()
    {
        return BlankCategory::get();
    }
